...
This is Second project in one the final projects from Udacity's React Nano Degree program. It is developed using Material-UI,React,Redux.
...
#### `git clone https://github.com/Usama-Aslam/would-you-rather-react.git`
